...
class VerifyWithOTP extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(mixed $notifiable): MailMessage
    {
        return (new MailMessage())
            ...
            ->line("This is your verification code for " . $this->otp->getAttribute('target'))
    ...
    {
        // TODO(Saifallak): Timing needs to be per user timezone.
        return [
